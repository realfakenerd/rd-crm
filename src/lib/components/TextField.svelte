<script lang="ts">
	...
	export let extraWrapperOptions = {} satisfies HTMLAttributes<HTMLElement>;
...
<section class="w-full" role="group" {...extraWrapperOptions}>
	<div
	...
	{#if supportingText}
		<p class="supporting" class:error id={`${id}-supporting`} aria-live="assertive">
			{supportingText}
		</p>
	{/if}
</section>
